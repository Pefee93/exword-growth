...
export function ContactSection() {
    ...
    return (
        <section className="relative z-10 w-full bg-[#1B0624] text-[#fbfbf9] px-6 md:px-12 py-32 rounded-t-[3rem] mt-32 overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-12 pt-4">
                            ...
                            <div className="flex items-center justify-end mt-4">
                                <button
                                    ...
                                    className="group relative overflow-hidden rounded-full bg-white text-[#1B0624] px-8 py-4 font-sans font-medium text-[15px] transition-all disabled:opacity-80 disabled:cursor-not-allowed flex items-center gap-3 w-full md:w-auto justify-center"
                                >
